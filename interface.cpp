...
int Interface::run() {
  ...
  a_spectrum = std::make_unique<Spectrum>(*gApp.controller->adeck->fftState, 200, win_height-500, 400, 400);
  b_spectrum = std::make_unique<Spectrum>(*gApp.controller->bdeck->fftState, 900, win_height-500, 400, 400);
