...
ENTRY = entry.o
BUT_ENTRY = finyl.o controller.o dev.o interface.o util.o action.o rekordbox.o kaitaistream.o rekordbox_pdb.o rekordbox_anlz.o dsp.o external/rubberband/single/RubberBandSingle.o external/fidlib/fidlib.o
