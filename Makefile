...
LDFLAGS = -lasound -lm -lSDL2 -lSDL2_ttf -lX11 -lcrypto -lstdc++

ENTRY = entry.o
BUT_ENTRY = finyl.o midi.o controller.o dev.o interface.o util.o action.o rekordbox.o kaitaistream.o rekordbox_pdb.o rekordbox_anlz.o dsp.o waveform.o list.o explorer.o external/rubberband/single/RubberBandSingle.o external/fidlib/fidlib.o
